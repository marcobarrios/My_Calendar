...
public class FragmentMonthCalender extends Fragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().setContentView(R.layout.fragment_view_calendario);

        _calendar = Calendar.getInstance(Locale.getDefault());
        month = _calendar.get(Calendar.MONTH) + 1;
        year = _calendar.get(Calendar.YEAR);
        Log.d(getTag(), "Calendar Instance:= " + "Month: " + month + " " + "Year: "
                + year);

        selectedDayMonthYearButton = (Button) getActivity().findViewById(R.id.selectedDayMonthYear);
